...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PahoLibraryAccessors laccForPahoLibraryAccessors = new PahoLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>paho</b>
     */
    public PahoLibraryAccessors getPaho() {
        return laccForPahoLibraryAccessors;
    }
    ...
    public static class PahoLibraryAccessors extends SubDependencyFactory {

        public PahoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>org.eclipse.paho:org.eclipse.paho.android.service</b> coordinates and
         * with version reference <b>paho.android</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("paho.android");
        }

        /**
         * Dependency provider for <b>mqtt</b> with <b>org.eclipse.paho:org.eclipse.paho.client.mqttv3</b> coordinates and
         * with version reference <b>paho.mqtt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMqtt() {
            return create("paho.mqtt");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final PahoVersionAccessors vaccForPahoVersionAccessors = new PahoVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.paho</b>
         */
        public PahoVersionAccessors getPaho() {
            return vaccForPahoVersionAccessors;
        }

    }

    public static class PahoVersionAccessors extends VersionFactory  {

        public PahoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>paho.android</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("paho.android"); }

        /**
         * Version alias <b>paho.mqtt</b> with value <b>1.2.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMqtt() { return getVersion("paho.mqtt"); }
